...
|---|---|---|
| Actual reduction | NOT YET SCORED | pending first pass |
| Measurement truth | NOT YET SCORED | pending first pass |
| Attribution | NOT YET SCORED | pending first pass |
| Cache plus startup | NOT YET SCORED | pending first pass |
| Personalization | NOT YET SCORED | pending first pass |
| Automation | NOT YET SCORED | pending first pass |
...
(none yet; first scored pass appends here with its release tag)
